...
cz_sorting("cz_qs","1",$_GET['Point'],$_GET['id'],$_GET['sid'],$config);
...
$Article=D("Home/qs_class")->find($id);
...
cz_class_sorting("cz_qs_class","0",$_GET['Point'],$_GET['id'],$_GET['sid'],$_GET['numberid'],$config);
echo "<script>self.location=document.referrer;</script>";
exit();	
}
