...
$Article=D("Home/ad")->find($id);          ###实例化Data数据对象
...
cz_sorting("cz_ad","1",$_GET['Point'],$_GET['id'],$_GET['sid'],$config);
...
$Article=D("Home/ad_class")->find($id);
...
cz_class_sorting("cz_ad_class","0",$_GET['Point'],$_GET['id'],$_GET['sid'],$_GET['numberid'],$config);
echo "<script>self.location=document.referrer;</script>";
exit();	
}
