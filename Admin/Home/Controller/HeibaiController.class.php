...
class HeibaiController extends CommonController {
//↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓以下调用首页内容	
...
cz_sorting("cz_heibai","1",$_GET['Point'],$_GET['id'],$_GET['sid'],$config);
...
$Article=D("Home/heibai_class")->find($id);
...
cz_class_sorting("cz_heibai_class","0",$_GET['Point'],$_GET['id'],$_GET['sid'],$_GET['numberid'],$config);
echo "<script>self.location=document.referrer;</script>";
exit();	
}
