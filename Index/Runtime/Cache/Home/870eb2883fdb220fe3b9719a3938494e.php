...
<head>
    <meta charset="utf-8">
<title>特码单双走势 － 六合开奖记录直播</title>
<meta name="keywords" content="一起发开奖现场,手机报码,特码单双走势,手机开奖网址" />
...
.zous-2col-long .zstable2-main-scrollbd {margin-top:20px;}
</style>
</head>
...
<td width="35" rowspan="2">期数</td>
<td width="35" rowspan="2">特码</td>
<td width="35" rowspan="2">单双</td>
<td colspan="2">单双走势</td>
<td colspan="2">特头单双走势</td>
<td colspan="2">合数单双走势</td>
</tr>
<tr style="background:#f9f9f9;">
<td style="width:140px;">单</td>
<td style="width:140px;">双</td>
<td style="width:140px;">头单</td>
<td style="width:140px;">头双</td>
<td style="width:140px;">合单</td>
<td style="width:140px;">合双</td>
</tr>
...
<td colspan="2"><font style="font-weight:normal; color:#999999">(请点击单双)</font></td>
<td class="cu" onClick="SelectNum(this,'Red','单');">单</td>
<td class="cu" onClick="SelectNum(this,'Red','双');">双</td>
<td class="cu" onClick="SelectNum(this,'Green','单');">头单</td>
<td class="cu" onClick="SelectNum(this,'Green','双');">头双</td>
<td class="cu" onClick="SelectNum(this,'Blue','单');">合单</td>
<td class="cu" onClick="SelectNum(this,'Blue','双');">合双</td>
</tr>
...
<td class="Blue"><FONT color=#ffffff><?php if($row['tit7'] % 2==1){echo "单";}else{echo "双";}?></FONT></td>
<?php  if($row['tit7'] % 2==1){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>单</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['tit7'] % 2==0){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>双</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['tit9'] % 2==1){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>单</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['tit9'] % 2==0){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>双</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if(strpos($row['tit22'],"合单") > 0){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>单</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if(strpos($row['tit22'],"合双") > 0){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>双</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
...
<td style="background:#efefef;" width="70" rowspan="2">期数</td>
<td style="background:#efefef;" width="40" rowspan="2">特码</td>
<td style="background:#efefef;" width="40" rowspan="2">单双</td>
<td>单</td>
<td>双</td>
<td>头单</td>
<td>头双</td>
