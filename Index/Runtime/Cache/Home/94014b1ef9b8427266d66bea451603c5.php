...
<title>性感美女_美女写真_<?=Cz_cig('site_name')?></title>
<meta name="keywords" content="性感美女,美女写真,六合美女" />
<meta name="description" content="性感美女_美女写真_<?=Cz_cig('site_name')?>" />
...
<p>您的位置：<a href="/">首页</a>&nbsp;>&nbsp;性感美女</p>
</div>
<div class="blank10"></div>
<div class="br bgff">
 <div class="title28_bord"><h4>推荐图片</h4></div>
<ul class="piclist" style="padding-left:8px">
<?php if(is_array($list1)): foreach($list1 as $key=>$vo): ?><li><a href="/meinv/<?php echo ($vo["id"]); ?>.html" alt="<?php echo ($vo["title"]); ?>" target="_blank"><img src="<?php echo ($vo["picurl"]); ?>" width="233" height="311" alt="<?php echo ($vo["title"]); ?>" /></a><p><a href="/meinv/<?php echo ($vo["id"]); ?>.html" alt="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></p></li><?php endforeach; endif; ?>
</ul>
<div class="blank10"></div>
</div>
<div class="blank10"></div>
<div class="br bgff">
 <div class="title28_bord"><h4>性感美女</h4></div>
<ul class="piclist" style="padding-left:8px">
<?php if(is_array($list)): foreach($list as $key=>$vo): if(is_array($vo['voo'])): $i = 0; $__LIST__ = $vo['voo'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li><a href="/meinv/<?php echo ($sub["id"]); ?>.html" alt="<?php echo ($sub["title"]); ?>" target="_blank"><img src="<?php echo ($sub["picurl"]); ?>" width="185" height="311" alt="<?php echo ($sub["title"]); ?>" /></a><p><a href="/meinv/<?php echo ($sub["id"]); ?>.html" alt="<?php echo ($sub["title"]); ?>" target="_blank"><?php echo ($sub["title"]); ?></a></p></li><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; ?>
</ul>
<div class="blank10"></div>
  ...
  <a id="scrollUp" href="javascript:;" title="飞回顶部"></a>
		...
		<script>
			var bgSelect = setInterval(function(){
				$(".Pic_nav").addClass("li_checked").siblings().removeClass("li_checked");
				if($(".Pic_nav").length != 0){
