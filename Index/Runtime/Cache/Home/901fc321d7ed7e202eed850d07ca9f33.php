...
<title>六合资料_<?=Cz_cig('site_name')?></title>
...
<style >
classbutton{
	width:99.961538461538461538461538461538%;/*960*/
}
.classbutton h2{
	font-size: 18px;
	line-height: 30px;
...
.classbutton a{
	...
	overflow: hidden;
	width: 7.0833333333333333333333333333333%;/*68*/
	height: 30px;
	line-height: 30px;
	font-size: 12px;
	text-align: center;
	...
	white-space: nowrap;
	float: left;
	margin: 4px .52083333333333333333333333333333%;/*5*/
	border-radius: 2px;
...
<div class="fleft" style="width:1000px">
<div class="br p10 bgff">
<p>您的位置：<a href="/">首页</a>&nbsp;&gt;&nbsp;<a href="">资料大全</a></p>
</div>
<div class="br bgff">
<div class="title28_bord"><span class="fright"></span><h4>资料大全</h4></div>
<div class="mcc_content">
<h2 class="div11">免费资料大全</h2>
<ul class="">
<?php if(is_array($list)): foreach($list as $key=>$vo): if(is_array($vo['voo'])): $i = 0; $__LIST__ = $vo['voo'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li class="div10">
<a href="/lists/<?php echo ($sub["id"]); ?>.html" class="div11" target="_blank"><?php echo ($sub["title"]); ?></a>
