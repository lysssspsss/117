...
<title>六合彩开奖记录搜索_查找历史开奖结果，可快速找到一肖一码中特等公式规律_<?=Cz_cig('site_name')?></title>
<meta name="keywords" content="六合彩开奖记录,历史开奖结果" />
...
<dd>
<ul>
<?php  for($i =1977; $i <= $dates; $i++) { ?>
<li><a href="?id=<?=$i?>"><?=$i?></a></li>
<?php } ?>
<li><a href="/Source/kj/<?=$dates?>/sx.html" target="_blank"><span style="background:#fefe00; color:#fe0000;">生肖属性</span></a></li>
</ul>
</dd>
</dl>
</div>
</div>
<form id="historySearchForm" action="" name="form1" method="post">
<input type="hidden" id="page" name="page" value="1"/>
<input type="hidden" id="pageSize" name="pageSize" value="<?=$pageSize?>"/>
<input type="hidden" id="numIndex" name="numIndex" value="3"/>
<div id="highterm" class="highterm">
<div class="inner1 main">
<h2>搜索开奖记录<small>历史开奖结果，最简单、最实用、最准确的公式规律。<font color="#FF6600">（哇！5年同期必出的一码一肖中特规律，你找到了吗？？）</font></small></h2>
<ul>
<li class="xianshi">
<label>显示类型：</label>
<input name="numNameCondition" class="<?php if ($numIndex=='0'){?>condition<?php }?>" value="显示全部"  onClick="historySearch('',1,30,0)"/>
<input name="numNameCondition" class="<?php if ($numIndex=='1'){?>condition<?php }?>" value="平一"  onClick="historySearch('',1,30,1)"/>
<input name="numNameCondition" class="<?php if ($numIndex=='2'){?>condition<?php }?>" value="平二"  onClick="historySearch('',1,30,2)"/>
<input name="numNameCondition" class="<?php if ($numIndex=='3'){?>condition<?php }?>"value="平三"  onClick="historySearch('',1,30,3)"/>
<input name="numNameCondition" class="<?php if ($numIndex=='4'){?>condition<?php }?>" value="平四"  onClick="historySearch('',1,30,4)"/>
<input name="numNameCondition" class="<?php if ($numIndex=='5'){?>condition<?php }?>" value="平五"  onClick="historySearch('',1,30,5)"/>
<input name="numNameCondition" class="<?php if ($numIndex=='6'){?>condition<?php }?>" value="平六"  onClick="historySearch('',1,30,6)"/>
<input name="numNameCondition" class="<?php if ($numIndex=='7'){?>condition<?php }?>" value="特码"  onClick="historySearch('',1,30,7)"/>
</li>
<li>
<label>时间期数：</label>
<select id="yearCondition" name="yearCondition" class="">
<option id="yearCondition" value="">选择年份</option>
<?php  for($i =$dates; $i >= 1976; $i--) { ?>
<option id="yearCondition<?=$i?>" value="<?=$i?>"><?=$i?></option>
<?php }?>
</select>
<input type="text" id="shortDateCondition" name="shortDateCondition" class="Wdate txt " onFocus="javascript:if(this.value=='选择日期'){this.value='';}" onClick="javascript:WdatePicker({dateFmt:'MM-dd'});" value="" />                
<select id="shortPeriodCondition" name="shortPeriodCondition" class="">
<option value="">选择期数</option>
<?php  for($i =1; $i <= 200; $i++){ $var=sprintf("%03d",$i) ?>
...
<?php  for($i =1; $i <= 49; $i++){ $var=sprintf("%02d",$i) ?>
<option value='<?=$var?>'><?=$var?></option>
<?php } ?>
</select>
...
<option value='虎'>虎</option><option value='兔'>兔</option><option value='龍'>龍</option><option value='蛇'>蛇</option><option value='馬'>馬</option><option value='羊'>羊</option><option value='猴'>猴</option><option value='雞'>雞</option><option value='狗'>狗</option><option value='豬'>豬</option>
</select>
<select id="num1ShengXiaoCondition" name="num1ShengXiaoCondition" class="">
<option value="">平一生肖</option>
<option value='鼠'>鼠</option><option value='牛'>牛</option><option value='虎'>虎</option><option value='兔'>兔</option><option value='龍'>龍</option><option value='蛇'>蛇</option><option value='馬'>馬</option><option value='羊'>羊</option><option value='猴'>猴</option><option value='雞'>雞</option><option value='狗'>狗</option><option value='豬'>豬</option>
</select>
...
<option value='紅'>紅</option><option value='藍'>藍</option><option value='綠'>綠</option>
</select>
...
<option value='紅肖'>紅肖</option><option value='藍肖'>藍肖</option><option value='綠肖'>綠肖</option>
</select>
...
<dl class="clearfix">
<dt><h2 style="background:#FFFF00">搜索结果</h2></dt>
<dd class="left">
<label>浏览方式：</label>
...
<dd class="right2"><a href="/Source/kj/<?=$dates?>/sx.html" target="_blank">[生肖号码属性表]</a></dd>
</dl>
</header>
<div class="bd">
<table>
...
<th class="max"><?php if ($numIndex=='0'){?>平码（六个正码）<?php } ?></th>
<th class="mini bg-high2">
<?php
if ($numIndex=='0'){ echo "特码"; }elseif ($numIndex=='1'){ echo "平一"; }elseif ($numIndex=='2'){ echo "平二"; }elseif ($numIndex=='3'){ echo "平三"; }elseif ($numIndex=='4'){ echo "平四"; }elseif ($numIndex=='5'){ echo "平五"; }elseif ($numIndex=='6'){ echo "平六"; }elseif ($numIndex=='7'){ echo "特码"; } ?>
</th>
...
<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="infolist">
<td class="no num"><?=date("Y-m-d",$vo['begtime'])?></td>
<td class="no bg-high2"><?php if (strstr($vo['title'], '期')){?>
<?=$vo['title']?>
<?php }else{?>
<?=$vo['title']?>期
<?php }?></td>
<td>
<?php if ($numIndex=='0'){?>
<div class="sortDown clearfix">
<div class="p">
<div class="hm <?=yx_no_band($vo['tit1'],5)?> "><?=$vo['tit1']?></div>
<div class="sx "><?=$vo['tit01']?></div>
</div>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit2'],5)?> "><?=$vo['tit2']?></div>
<div class="sx "><?=$vo['tit02']?></div>
</div>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit3'],5)?> "><?=$vo['tit3']?></div>
<div class="sx "><?=$vo['tit03']?></div>
</div>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit4'],5)?> "><?=$vo['tit4']?></div>
<div class="sx "><?=$vo['tit04']?></div>
</div>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit5'],5)?> "><?=$vo['tit5']?></div>
<div class="sx "><?=$vo['tit05']?></div>
</div>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit6'],5)?>"><?=$vo['tit6']?></div>
<div class="sx "><?=$vo['tit06']?></div>
</div>
</div>
<?php } ?>
</td>
<td class="bg-high2">
<?php if ($numIndex=='0' || $numIndex=='7'){?>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit7'],5)?> "><?=$vo['tit7']?></div>
<div class="sx "><?=$vo['tit07']?></div>
</div>
<?php }elseif ($numIndex=='1'){?>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit1'],5)?> "><?=$vo['tit1']?></div>
<div class="sx "><?=$vo['tit01']?></div>
</div>
<?php }elseif ($numIndex=='2'){?>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit2'],5)?> "><?=$vo['tit2']?></div>
<div class="sx "><?=$vo['tit02']?></div>
</div>
<?php }elseif ($numIndex=='3'){?>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit3'],5)?> "><?=$vo['tit3']?></div>
<div class="sx "><?=$vo['tit03']?></div>
</div>
<?php }elseif ($numIndex=='4'){?>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit4'],5)?> "><?=$vo['tit4']?></div>
<div class="sx "><?=$vo['tit04']?></div>
</div>
<?php }elseif ($numIndex=='5'){?>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit5'],5)?> "><?=$vo['tit5']?></div>
<div class="sx "><?=$vo['tit05']?></div>
</div>
<?php }elseif ($numIndex=='6'){?>
<div class="p">
<div class="hm <?=yx_no_band($vo['tit2'],6)?> "><?=$vo['tit6']?></div>
<div class="sx "><?=$vo['tit06']?></div>
</div>
<?php } ?>
</td>
<td  class=""><?=$vo['tit07']?></td>
<td class="<?=yx_Other_class($vo['tit7'],1,0)?> "><?=yx_Other_class($vo['tit7'],2,0)?> </td>
<td  class="<?=yx_no_band($vo['tit7'],8)?>"><?=$vo['bands']?></td>
<td class="<?=yx_Other_class($vo['tit7'],1,1)?>"><?=yx_Other_class($vo['tit7'],2,1)?></td>
<td class="<?=yx_wuxing_class(cz_lhc_xiao(3,$vo['tit7']))?> "><?=cz_lhc_xiao(3,$vo['tit7'])?></td>
<td class="tou<?=substr($vo['tit7'],0,1)?>Class "><?=substr($vo['tit7'],0,1)?>头</td>
<td class=""><?=substr($vo['tit7'],1,1)?>尾</td>
<td class="">
<?php
$heshu=substr($vo['tit7'],0,1)+substr($vo['tit7'],1,1); if ($heshu<=9){ $heshus="0".$heshu; }else{ $heshus=$heshu; } if ($heshu % 2 ==0){ echo $heshus."和双"; }else{ echo $heshus."和单"; } ?>
</td>
<td class="<?=yx_Other_class($vo['tit11'],1,1)?> "><?=$vo['tit11']?></td>
<td class="menshu<?=cz_lhc_xiao(11,$vo['tit7'])?>Class "><?=cz_lhc_xiao(11,$vo['tit7'])?>门</td>
<td class="duanwei<?=cz_lhc_xiao(9,$vo['tit7'])?>Class "><?=cz_lhc_xiao(9,$vo['tit7'])?>段</td>
<td class="<?=yx_Other_txt(cz_lhc_xiao(21,$vo['tit07']))?>"><?=cz_lhc_xiao(21,$vo['tit07'])?></td>
<td class="<?=yx_Other_txt(cz_lhc_xiao(22,$vo['tit07']))?>"><?=cz_lhc_xiao(22,$vo['tit07'])?></td>
<td class="<?=yx_Other_txt(cz_lhc_xiao(23,$vo['tit07']))?>"><?=cz_lhc_xiao(23,$vo['tit07'])?></td>
<td class="<?=yx_Other_txt(cz_lhc_xiao(20,$vo['tit07']))?>"><?=cz_lhc_xiao(20,$vo['tit07'])?></td>
<td class="<?=yx_Other_txt(cz_lhc_xiao(20,$vo['tit07']))?>"><?=cz_lhc_xiao(24,$vo['tit07'])?></td>
<td class="<?=yx_Other_txt(cz_lhc_xiao(20,$vo['tit07']))?>"><?=cz_lhc_xiao(25,$vo['tit07'])?></td>
<td class="<?=yx_Other_txt(cz_lhc_xiao(20,$vo['tit07']))?>"><?=cz_lhc_xiao(26,$vo['tit07'])?></td>
<td>
<?php
$zonger=$vo['tit1']+$vo['tit2']+$vo['tit3']+$vo['tit4']+$vo['tit5']+$vo['tit6']+$vo['tit7']; if ($zonger<=175){ $show="(".$zonger.")≤175"; }else{ $show="(".$zonger.")≥176"; } if ($zonger % 2 ==0){ echo $show."<span class='shuangClass'>双</span>"; }else{ echo $show."<span class='danClass'>单</span>"; } ?>
</td>
  ...
  <a id="scrollUp" href="javascript:;" title="飞回顶部"></a>
		...
		<script>
			var bgSelect = setInterval(function(){
				$(".History_nav").addClass("li_checked").siblings().removeClass("li_checked");
				if($(".History_nav").length != 0){
