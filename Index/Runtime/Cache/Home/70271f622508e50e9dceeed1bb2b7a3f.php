...
<tbody>
<tr class="header">
<td colspan="2"><span class="fright"></span><span class="fleft">六合彩挑码工具</span></td>
</tr>
</tbody>
</table>
<div class="blank"></div>
...
<div class="blank"></div>
<?php
 $mid=$_GET["d"]; $url="http://www.178kj.cc/gongju.html"; $contents = file_get_contents($url); $contents = str_replace('</style>','</style><link type="text/css" rel="stylesheet" href="/Index/Public/wap/rq.css"/>',$contents); echo $contents; ?>
