...
<head>
    <meta charset="utf-8">
<title>特码波色走势 － 六合开奖记录直播</title>
<meta name="keywords" content="一起发开奖现场,手机报码,特码波色走势,手机开奖网址" />
...
<td width="40" rowspan="2">期号</td>
<td width="40" rowspan="2">特码</td>
<td width="40" rowspan="2">特肖</td>
<td colspan="3">波色走势</td>
<td colspan="6">半波走势</td>
</tr>
...
<td colspan="2"><font style="font-weight:normal; color:#999999">(请点击波色)</font></td>
<td class="cu" onClick="SelectNum(this,'Red','紅');">紅</td>
<td class="cu" onClick="SelectNum(this,'Blue','藍');">藍</td>
<td class="cu" onClick="SelectNum(this,'Green','綠');">綠</td>
<td class="white enfont cu" onClick="SelectNum(this,'Red','单');">紅单</td>
<td class="white enfont cu" onClick="SelectNum(this,'Blue','单');">藍单</td>
<td class="white enfont cu" onClick="SelectNum(this,'Green','单');">綠单</td>
<td class="white enfont cu" onClick="SelectNum(this,'Red','双');">紅双</td>
<td class="white enfont cu" onClick="SelectNum(this,'Blue','双');">藍双</td>
<td class="white enfont cu" onClick="SelectNum(this,'Green','双');">綠双</td>
...
<td class="Blue"><?php if($row['tit7'] % 2==1){echo "单";}else{echo "双";}?></td>
<?php  if($row['bands']=='紅'){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>紅</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['bands']=='藍'){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>藍</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['bands']=='綠'){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>綠</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['bands']=='紅' and $row['tit7'] % 2==1){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>单</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['bands']=='藍' and $row['tit7'] % 2==1){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>单</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['bands']=='綠' and $row['tit7'] % 2==1){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>单</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['bands']=='紅' and $row['tit7'] % 2==0){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>双</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['bands']=='藍' and $row['tit7'] % 2==0){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>双</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
<?php  if($row['bands']=='綠' and $row['tit7'] % 2==0){?><td class="<?=yx_no_band($row['tit7'],4)?>"><FONT color=#ffffff>双</FONT></td><?php }else{?><td class="hui_color">-</td><?php } ?>
