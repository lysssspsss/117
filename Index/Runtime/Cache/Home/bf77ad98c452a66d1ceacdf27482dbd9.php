...
<head>
    <meta charset="utf-8">
<title>男女生肖统计走势图 － 六合开奖记录直播</title>
<meta name="keywords" content="一起发开奖现场,手机报码,男女生肖统计走势图,手机开奖网址" />
...
<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>平</td><td>码</td><td>比</td><td>值</td><td>天</td><td>:</td><td>地</td><td>所有</td></tr>
<tr ><td>一码</td><td>二码</td><td>三码</td><td>四码</td><td>五码</td><td>六码</td><td>特码</td><td>一码</td><td>二码</td><td>三码</td><td>四码</td><td>五码</td><td>六码</td><td>特码</td><td>一肖</td><td>二肖</td><td>三肖</td><td>四肖</td><td>五肖</td><td>六肖</td><td>特肖</td><td>6:0</td><td>5:1</td><td>4:2</td><td>3:3</td><td>2:4</td><td>1:5</td><td>0:6</td><td>男:女</td></tr>
...
<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
<?php
if (in_array($vo['tit01'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit02'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit03'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit04'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit05'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit06'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit07'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $zongy=$pingy+1; }else{ $zongb=$pingb+1; } ?>
...
<?php
if (in_array($vo['tit01'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $nums1=$nums1+1; ?>
<td class="abg">男</td>
...
<?php
if (in_array($vo['tit02'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $nums2=$nums2+1; ?>
<td class="abg">男</td>
...
<?php
if (in_array($vo['tit03'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $nums3=$nums3+1; ?>
<td class="abg">男</td>
...
<?php
if (in_array($vo['tit04'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $nums4=$nums4+1; ?>
<td class="abg">男</td>
...
<?php
if (in_array($vo['tit05'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $nums5=$nums5+1; ?>
<td class="abg">男</td>
...
<?php
if (in_array($vo['tit06'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $nums6=$nums6+1; ?>
<td class="abg">男</td>
<?php }else{ $nums06=$nums06+1; ?>
<td class="bbg">女</td>
<?php } ?>
<?php
if (in_array($vo['tit07'], array("鼠","牛","虎","龍","馬","猴","狗"))){ $nums7=$nums7+1; ?>
<td class="abg">男</td>
...
<tr ><td>一码</td><td>二码</td><td>三码</td><td>四码</td><td>五码</td><td>六码</td><td>特码</td><td>一码</td><td>二码</td><td>三码</td><td>四码</td><td>五码</td><td>六码</td><td>特码</td><td>一肖</td><td>二肖</td><td>三肖</td><td>四肖</td><td>五肖</td><td>六肖</td><td>特肖</td><td>6:0</td><td>5:1</td><td>4:2</td><td>3:3</td><td>2:4</td><td>1:5</td><td>0:6</td><td>男:女</td></tr>
<tr><td></td><td></td><td></td><td></td><td></td><td>统计</td><td>男:女</td>
<td><?=$nums1?>:<?=$nums01?></td>
<td><?=$nums2?>:<?=$nums02?></td>
<td><?=$nums3?>:<?=$nums03?></td>
<td><?=$nums4?>:<?=$nums04?></td>
...
<ul class="zous-list">
    属性说明：将12生肖分为男,女两组。<li >1、男=鼠,牛,虎,龍,馬,猴,狗</li><li >2、女=兔,蛇,羊,雞,豬</li>
