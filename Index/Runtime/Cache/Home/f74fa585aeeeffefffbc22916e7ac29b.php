...
<tbody>
<tr class="header">
<td colspan="2"><span class="fright"></span><span class="fleft">性感美女</span></td>
</tr>
</tbody>
</table>
<div class="listmain">
	  <ul id="container">
<?php if(is_array($list)): foreach($list as $key=>$vo): if(is_array($vo['voo'])): $i = 0; $__LIST__ = $vo['voo'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li>
		  <div class="libox"><a href="/pic_detail/id/<?php echo ($sub["id"]); ?>.html"><img style="display: inline;" alt="<?php echo ($sub["title"]); ?>" src="<?php echo ($sub["picurl"]); ?>" height="280"><span><?php echo ($sub["title"]); ?></span></a></div>
		</li><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; ?>		
	  </ul>
	</div>
<div class="list_page"><ul><?php echo ($page); ?></ul></div>	
</div>
<div class="blank"></div>
