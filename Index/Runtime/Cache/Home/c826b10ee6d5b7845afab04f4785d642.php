...
<head>
    <meta charset="utf-8">
<title>阴阳生肖统计走势图 － 六合开奖记录直播</title>
<meta name="keywords" content="一起发开奖现场,手机报码,阴阳生肖统计走势图,手机开奖网址" />
...
<?php if(is_array($list)): foreach($list as $key=>$vo): if (in_array($vo['tit01'], array("鼠","龍","蛇","馬","狗","豬"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit02'], array("鼠","龍","蛇","馬","狗","豬"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit03'], array("鼠","龍","蛇","馬","狗","豬"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit04'], array("鼠","龍","蛇","馬","狗","豬"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit05'], array("鼠","龍","蛇","馬","狗","豬"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit06'], array("鼠","龍","蛇","馬","狗","豬"))){ $pingy=$pingy+1; $zongy=$pingy; }else{ $pingb=$pingb+1; $zongb=$pingb; } if (in_array($vo['tit07'], array("鼠","龍","蛇","馬","狗","豬"))){ $zongy=$pingy+1; }else{ $zongb=$pingb+1; } ?>
<tr>
...
<?php
if (in_array($vo['tit01'], array("鼠","龍","蛇","馬","狗","豬"))){ $nums1=$nums1+1; ?>
<td class="abg">阴</td>
...
<?php
if (in_array($vo['tit02'], array("鼠","龍","蛇","馬","狗","豬"))){ $nums2=$nums2+1; ?>
<td class="abg">阴</td>
...
<?php
if (in_array($vo['tit03'], array("鼠","龍","蛇","馬","狗","豬"))){ $nums3=$nums3+1; ?>
<td class="abg">阴</td>
...
<?php
if (in_array($vo['tit04'], array("鼠","龍","蛇","馬","狗","豬"))){ $nums4=$nums4+1; ?>
<td class="abg">阴</td>
...
<?php
if (in_array($vo['tit05'], array("鼠","龍","蛇","馬","狗","豬"))){ $nums5=$nums5+1; ?>
<td class="abg">阴</td>
...
<?php
if (in_array($vo['tit06'], array("鼠","龍","蛇","馬","狗","豬"))){ $nums6=$nums6+1; ?>
<td class="abg">阴</td>
<?php }else{ $nums06=$nums06+1; ?>
<td class="bbg">阳</td>
<?php } ?>
<?php
if (in_array($vo['tit07'], array("鼠","龍","蛇","馬","狗","豬"))){ $nums7=$nums7+1; ?>
<td class="abg">阴</td>
...
<tr ><td>一码</td><td>二码</td><td>三码</td><td>四码</td><td>五码</td><td>六码</td><td>特码</td><td>一码</td><td>二码</td><td>三码</td><td>四码</td><td>五码</td><td>六码</td><td>特码</td><td>一肖</td><td>二肖</td><td>三肖</td><td>四肖</td><td>五肖</td><td>六肖</td><td>特肖</td><td>6:0</td><td>5:1</td><td>4:2</td><td>3:3</td><td>2:4</td><td>1:5</td><td>0:6</td><td>阴:阳</td></tr>
<tr><td></td><td></td><td></td><td></td><td></td><td>统计</td><td>阴:阳</td>
<td><?=$nums1?>:<?=$nums01?></td>
<td><?=$nums2?>:<?=$nums02?></td>
<td><?=$nums3?>:<?=$nums03?></td>
<td><?=$nums4?>:<?=$nums04?></td>
...
<ul class="zous-list">
	属性说明：将12生肖分为阴,阳两组。
	<li>1、阴=鼠,龍,蛇,馬,狗,豬</li>
	<li>2、阳=牛,虎,兔,羊,猴,雞</li>
