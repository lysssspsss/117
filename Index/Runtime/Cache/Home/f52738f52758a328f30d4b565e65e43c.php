...
<title>六合特码走势_<?=Cz_cig('site_name')?></title>
<meta name="keywords" content="六合特码走势" />
<meta name="description" content="六合特码走势_<?=Cz_cig('site_name')?>" />
...
<li><a href="<?php echo U('Home/Charts/lhc1');?>?id=<?=$i?>"><?=$i?></a></li>
<?php } ?>
</ul>
</dd>
</dl>
...
<div class="main">
<ul class="zs_nav">
<li><a href="<?php echo U('Home/Charts/index');?>">出号综合分析</a></li>
<li class='cur'><a href="<?php echo U('Home/Charts/lhc1');?>">六合特码走势</a></li>
...
<TABLE class="zstable" style="width:1384px;">
...
<td style="width:25px;">01</td>
<td style="width:25px;">02</td>
<td style="width:25px;">03</td>
<td style="width:25px;">04</td>
<td style="width:25px;">05</td>
<td style="width:25px;">06</td>
<td style="width:25px;">07</td>
<td style="width:25px;">08</td>
<td style="width:25px;">09</td>
...
<?php
for($i =1; $i <= 49; $i++){ if($i<=10){ $i='0'.$i; } if (strstr($i,$row['tit7'])){ $sums=$i; $color=yx_no_band($i,2); }else{ $sums="-"; $color='hui_color'; } ?>
