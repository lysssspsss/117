...
<div id="top1"></div>
<div class="nav-dh">
    <a href="/m_index.html">首页</a><a href="/lists/m_bbs.html">高手帖</a>
</div>
			<!--广告开始-->
			...
			<!--广告结束-->
<div class="fl-list">
<div width="100%" border="0" id="www_117kj_cc">
...
<li><a href="/bbs/m_<?php echo ($sub["id"]); ?>.html"><?php echo (mb_substr($sub["title"],0,200,'utf-8')); ?></a></li>
...
onload=function(){
obj=document.getElementById("www_117kj_cc").getElementsByTagName("ul");
j=obj.length
